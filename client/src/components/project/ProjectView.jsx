    ...
    return (
        <div>
            <div className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-2xl">
                <div className=" flex items-center justify-between  mb-4">
                    ...
                    <div className=" flex gap-5">
                        ...
                        <button onClick={() => document.getElementById("my_modal_5").showModal()}>
                            <img src="/assets/trash.svg" className=" cursor-pointer" alt="ds" width={30} />
                        </button>
                    </div>
                    ...
                    <dialog id="my_modal_5" className="modal modal-bottom sm:modal-middle">
                        <div className="modal-box">
                            ...
                            <p className="py-4">Press ESC key or click Cancel button below to Cancel the process</p>
                    ...
                    <dialog id="my_modal_2" className="modal">
                        <div className=" modal-box ">
                            <form onSubmit={handleSubmit}>
                                ...
                                />
                                <button className=" text-center w-full bg-green-500 rounded-md font-bold py-2">
                                    Save
                                </button>
                            </form>
                        </div>
                ...
                <p className="text-gray-700">
                    <span className="font-semibold">Created By:</span> {project.createdBy?.name || "Unknown"}
                </p>
                    ...
                    {project.tenders?.length > 0 ? (
                        <ul className="list-disc pl-5 text-gray-600">
                            {project.tenders.map((tender, index) => (
                                <li key={index}>{tender.name || "Tender ID: " + tender._id}</li>
                            ))}
                        </ul>
                    ) : (
